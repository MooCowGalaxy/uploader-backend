...
function toggleNavbarDropdown() {
    if (!isDropdownVisible) {
        ...
        $('#navbar-dropdown-icon').addClass('hidden')
        $('#navbar-dropdown-icon-focus').removeClass('hidden')
        $('#n-dropdown').removeClass('hidden')
    } else {
        isDropdownVisible = false
        $('#navbar-dropdown-icon').removeClass('hidden')
        $('#navbar-dropdown-icon-focus').addClass('hidden')
            ...
            if (data.success) {
                ...
                $(document).ready(() => {
                    if (window.location.pathname.startsWith('/dashboard')) {
                        ...
                        <i id="navbar-dropdown-icon" class="inline-block align-middle mb-0.5">
                        ...
                        <i id="navbar-dropdown-icon-focus" class="inline-block align-middle mb-0.5 hidden">
