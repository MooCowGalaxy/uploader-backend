...
function setIcon() {
    document.getElementById('navbar-dark').innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" class="${isLoggedIn ? 'block translate-y-1 ' : ''}text-white h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ${isDarkMode() ?
            ...
            if (data.success) {
                ...
                $(document).ready(() => {
                    if (window.location.pathname.startsWith('/dashboard')) {
                        ...
                        $('#nav-dropdown').html(`
                        <button id="navbar-dark" class="rounded-full mr-2 no-transition"></button>
